...
module.exports = grammar({
  ...
  rules: {
    ...
    input_stmt: $ => seq('input', $.identifier, ';'),
    secret_stmt: $ => seq('secret', $.identifier, ';'),
    output_stmt: $ => seq('output', $._expr, ';'),
    assert_stmt: $ => seq('assert', $._expr, ';'),
    ...
    unary: $ => prec(4, seq('-', $._expr)),
    call: $ => prec(5, seq($.identifier, '(', optional($._args), ')')),
    index: $ => prec(5, seq($.identifier, '[', $._expr, ']')),
