...
pub(crate) const ASSOC_ROOT: usize = 4;
pub(crate) const NF0: usize = 8;
pub(crate) const NF1: usize = 12;
pub(crate) const OUT_CM0: usize = 16;
pub(crate) const OUT_CM1: usize = 20;
pub(crate) const PUBLIC_AMOUNT: usize = 24;
pub(crate) const FEE: usize = 25;
pub(crate) const ASSET_ID: usize = 26;
pub(crate) const CLEARING_PRICE: usize = 27;
pub(crate) const RECIPIENT: usize = 28;
pub(crate) const WORDS: usize = 29;
