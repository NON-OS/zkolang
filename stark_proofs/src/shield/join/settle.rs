...
/// Terms the circuit does not compute: the settlement destination, the
/// association set the pool gates on, and the batch clearing price. They are
...
pub(crate) struct Settle {
    pub assoc_root: [Fp; crate::crypto::stark::air::RATE],
